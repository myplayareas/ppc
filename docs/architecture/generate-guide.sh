...
cp -a ./plantuml/guide_tools/*.css ./output/
...
pandoc -s -c pandoc.css ./plantuml/guide_tools/index.md -o ./output/index_multipage.html
pandoc -s --toc -c pandoc.css -B ./plantuml/guide_tools/header.html -A ./.pa/guide_tools/footer.html ./output/fragments/*.html -o ./output/index.html
